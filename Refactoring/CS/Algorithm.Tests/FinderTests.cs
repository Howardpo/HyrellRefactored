...
{    
    public class FinderTests
    {
        ...
        public void Returns_Empty_Results_When_Given_Empty_List()
        {
            ...
            var finder = new BirthdayDistanceFinder(list);

            var result = finder.Find(BirthdayDistance.ClosestBirthdays);
        ...
        public void Returns_Furthest_Two_For_Two_People()
        {
            ...
            var result = finder.Find(BirthdayDistance.FarthestBirthdays);
